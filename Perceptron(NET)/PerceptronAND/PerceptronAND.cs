...
namespace Perceptron_NET_
{
    ...
    {
        /// <summary>
        /// Entradas de para funcion AND.
        /// </summary>
        public static double[][] ANDInput =
        {
            new[] {0.0, 0.0},
            new[] {0.0, 1.0},
            new[] {1.0, 0.0},
        ...
        /// <summary>
        /// Salidas deseadas para la funcion AND.
        /// </summary>
        public static double[][] ANDIdeal =
        {
            new[] {0.0},
            new[] {0.0},
            new[] {0.0},
        ...
        static void Main(string[] _)
        {
            ...
            IMLDataSet trainingSet = new BasicMLDataSet(ANDInput, ANDIdeal);
