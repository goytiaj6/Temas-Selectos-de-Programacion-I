...
namespace Perceptron_NET_
{
    class PerceptronXOR
    {
        ...
        /// <summary>
        /// Salidas deseadas para la funcion XOR.
        /// </summary>
        ...
        static void Main(string[] _)
        {
            ...
            //La configuracion de la compuerta XOR, consta de una capa oculta de 3 nueronas
            network.AddLayer(new BasicLayer(new ActivationSigmoid(), true, 3));
            //Se agrega la capa de salida de la red, siendo una sola neurona
